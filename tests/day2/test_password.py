...
from classes.day2.password import PasswordVerifier

class TestPasswordVerified(unittest.TestCase):

    def testPwdVerifier_MinRuleFulfilled(self):
        input = ["1-2 a: abcde"]
        verifier = PasswordVerifier()
        self.assertEqual(1, verifier.verifyPasswordList(input))

    def testPwdVerifier_MaxRuleFulfilled(self):
        input = ["1-2 a: aabcde"]
        verifier = PasswordVerifier()
        self.assertEqual(1, verifier.verifyPasswordList(input))

    def testPwdVerifier_MinRuleNotFulfilled(self):
        input = ["1-2 a: bcde"]
        verifier = PasswordVerifier()
        self.assertEqual(0, verifier.verifyPasswordList(input))

    def testPwdVerifier_MaxRuleNotFulfilled(self):
        input = ["1-2 a: aaabcde"]
        verifier = PasswordVerifier()
        self.assertEqual(0, verifier.verifyPasswordList(input))

    def testPwdVerifier_WrongPwdInput(self):
        input = ["1-2 a: aabcde", "3-5 a: aabcde"]
        verifier = PasswordVerifier()
        self.assertEqual(1, verifier.verifyPasswordList(input))

    def testPwdVerifier_WrongPwdInput2(self):
        input = ["1-3 a: abcde",
"1-3 b: cdefg",
"2-9 c: ccccccccc"]
        verifier = PasswordVerifier()
        self.assertEqual(2, verifier.verifyPasswordList(input))

    def testAdventInput(self):
        input = ["3-4 l: vdcv",
"6-9 d: dddddkzdl",
...
"4-5 c: ccchc"]
        verifier = PasswordVerifier();
        print(verifier.verifyPasswordList(input))